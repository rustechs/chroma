...
- Mouse attractor feel: `mouse_inertia`, `mouse_spring_rate`, `mouse_damping`, `mouse_hover_influence`, `mouse_press_influence` (config-only; see [PARAMETERS.md](./PARAMETERS.md))
